<footer class=" border border-black border-opacity-5 rounded-xl text-center py-16 px-10 mt-16" style="background-color: rgb(43, 45, 66);color:rgb(237, 242, 244);">
    <img src="/images/lary-newsletter-icon.svg" alt="" class="mx-auto -mb-6" style="width: 145px;">
    <h5 class="text-3xl">Stay in touch with the latest posts</h5>
    <p class="text-sm mt-3">Promise to keep the inbox clean. No bugs.</p>

    <div class="mt-10">
        <div class="relative inline-block mx-auto rounded-full" style="background-color:rgb(237, 242, 244);">
